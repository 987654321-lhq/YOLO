...
def estimateAnchorBoxes(trainingData, numAnchors=9, SIZE=640):
    '''
...
def calculate_anchors(dataset_anno_path=r'./datasets/RoadSignsPascalVOC/Annotations', anchorsPath='./yolo_anchors.txt',
                      anchors_num=9, SIZE=640):
...
if __name__ == "__main__":
    # 数据集xml注释路径
    # dataset_anno_path = r"D:/PostgaduateStudies/Machine Learning Dataset/Disease Lemon Leaf/Xml"

    dataset_anno_path = r"VOCdevkits/VOC2012/Annotations"
    # 生成的anchors的txt文件保存路径
    anchorsPath = 'testSet.txt'
    # 生成的anchors数量
    anchors_num = 9
    # 输入的图片尺寸
    SIZE = 640
